...
<body>
	...
	<div class="wrapper">
		...
		<form class="form-right" id="myform">
			...
			<div class="row py-6">
				...
				<div class="col-lg-11 control-label">
					<input type="text" name="name" id="userName" class="input-field">
				</div>
			</div>
			...
			<div class="row py-6">
				...
				<div class="col-lg-11 control-label">
					<input type="text" name="empid" id="empid" class="input-field">
				</div>
			</div>
			<div class="row py-6">
				<div class="col-lg-1 control-label  py-13">
			...
			<div class="col-12 text-center">
				...
				<button class="btn btn-primary text-center" type="submit">Submit
					form</button>
			</div>
